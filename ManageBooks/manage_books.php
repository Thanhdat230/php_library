        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mt-5 mb-3 clearfix">
                    ...
                    <a href="" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Books</a>
                </div>
                <?php
                //Include config file
                ...
                if($result = $mysqli->query($sql)){
                    if($result->num_rows > 0){
                        ...
                        echo"<th>Author</th>";
                        echo"<th>Book since</th>";
                        echo"<th>Book status</th>";
                        echo"<th>Specialized Book</th>";
                        echo"<th>Action</th>";
                        echo "</tr>";
                        echo "</thead>";
                        echo "<tbody>";
                        while ($row = $result->fetch_array()){
                            ...
                            echo "<td>" .$row['macn'] ."</td>";
                            echo "<td>";
                            echo '<a href="read.php?id=' .$row['sach_id'].'" class="mr-3" title="View Record" 
                                            data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                            echo '<a href="update.php?id=' .$row['sach_id'].'" class="mr-3" title="Update Record"
                                            data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                            echo '<a href="delete.php?id=' .$row['sach_id'].'" class="mr-3" title="Delete Record"
